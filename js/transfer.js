...
if (BALANCE === 0) {
  let __HTML_STRING = ("<h3>Transfer Funds</h3><p id='no-funds-notice'>Once you've been paid for waking up on time, you'll be able to transfer funds to your Venmo or bank account.</p><br><button class='full-width gradient'>Schedule a Wakeup</button><br>")
  if (IS_2X) {
